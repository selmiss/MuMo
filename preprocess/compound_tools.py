# This code is from a publicly available implementation.
...
from preprocess.compound_constants import DAY_LIGHT_FG_SMARTS_LIST
...
class Compound3DKit(object):
    ...
    def get_MMFF_atom_poses(mol, numConfs=None, return_energy=False):
        ...
        try:
            print("Atom Nums:", mol.GetNumAtoms())
